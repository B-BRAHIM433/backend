...
// // NEW: Callback endpoint that matches GitHub Actions (scan-callback)
// app.post('/api/scan-callback', async (req, res) => {
//   try {
//     console.log('📥 Callback reçu:', JSON.stringify(req.body, null, 2));
...
//         // 🔹 Enregistrer les vulnérabilités si elles existent
//         if (results && results.vulnerabilities && Array.isArray(results.vulnerabilities)) {
//           console.log(`🛡️ Insertion de ${results.vulnerabilities.length} vulnérabilités dans la base...`);
...
//     endpoints: [
//       'POST /api/scan/trigger',
//       'POST /api/scan-callback', // Updated endpoint name
//       'POST /api/scan/results (legacy)',
//       'GET /api/scans',
//       'GET /api/scan/:id',
//       'GET /api/stats',
